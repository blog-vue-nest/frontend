  ...
  <section>
      <article class="relative px-[17px] pt-[20px] pb-[28px] border border-[#DBDBDB] rounded-[11.488px] md:p-0 md:border-none">
        ...
        2xl:pt-[32px] 2xl:pl-[32px] 2xl:pb-[42px] 2xl:pr-[104px] 2xl:rounded-[16px]">
          ...
          2xl:text-[32px] 2xl:leading-[45px] 2xl:tracking-[-1px]">How to make a Game look more attractive with New VR & AI Technology</h3>
          <p class="mt-[27px] font-roboto-400 text-dark-gray text-[12px] leading-[150%] 2xl:text-[16px]">Google has been investing in AI for many years and bringing its benefits to individuals, businesses and communities. Whether it’s publishing state-of-the`everyone.
</p>
          <button class="mt-[21px] border-[0.718px] border-violet rounded-[5.744px] px-[35px] py-[12px] capitalize font-roboto-700 text-[10px] leading-[150%] text-violet
          2xl:text-[14px] 2xl:px-[48px] 2xl:py-[16px] 2xl:rounded-[8px]">Read more</button>
        </div>
      </article>
    </section>
      ...
      <section>
        <div class="flex justify-between items-center mt-[65px] md:mt-[125px] 2xl:mt-[160px]">
          ...
          md:text-[35px] 2xl:text-[48px] 2xl:leading-[50px] 2xl:tracking-[-0.88px]">Our Recent Post</h2>
          <button class="capitalize px-[35px] py-[12px] bg-violet rounded-[6px] font-roboto-700 text-white text-[10px] leading-[150%]
...
<article class="flex gap-[40px]">
       ...
       <section>
        <div class="flex justify-between items-center mt-[65px] md:mt-[125px] 2xl:mt-[160px]">
          <h2 class="capitalize font-raleway-700 text-dark text-[20px] leading-[36px] tracking-[-0.632px]
          md:text-[35px] 2xl:text-[48px] 2xl:leading-[50px] 2xl:tracking-[-0.88px]">Popular Post</h2>
          <button class="capitalize px-[35px] py-[12px] bg-violet rounded-[6px] font-roboto-700 text-white text-[10px] leading-[150%]
          2xl:text-[14px] 2xl:rounded-[8px] 2xl:py-[16px] 2xl:px-[48px]">View all</button>
        </div>
